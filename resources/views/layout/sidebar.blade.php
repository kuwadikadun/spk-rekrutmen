                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="{{ url('kategori') }}" aria-expanded="false">
                            <i class="icon-notebook menu-icon"></i><span class="nav-text">Kategori</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li class="mega-menu mega-menu-sm">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ url('/tes_interview') }}">Interview</a></li>
                            <li><a href="./layout-one-column.html">Bidang</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ url('user') }}" aria-expanded="false">
                            <i class="icon-people menu-icon"></i><span class="nav-text">Data User</span>
                        </a>
                    </li>
                </ul>
            </div>
